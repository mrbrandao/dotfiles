 ...
 */
/*char font[] = "Courier:pixelsize=13:antialias=true:autohint=true";*/
//char font[] = "Monospace:pixelsize=13:antialias=true:autohint=true";
char font[] = "SauceCodePro Nerd Font:pixelsize=13:antialias=true:autohint=true";
int borderpx = 1;
 ...
 */
unsigned int defaultfg = 247;
unsigned int defaultbg = 0;
unsigned int defaultcs = 239;
unsigned int defaultrcs = 247;
